const CACHE="ram-fit-v8";
const ASSETS=["./","./index.html","./styles.css","./app.js","./reminder-enhance.js","./workout-flex.js","./health-tracking.js","./report-share.js","./barcode-food.js","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
