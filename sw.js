const CACHE="ram-fit-v3";
const ASSETS=["./","./index.html","./styles.css","./app.js","./reminder-enhance.js","./workout-flex.js","./health-tracking.js","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
